    ...
    <>
      ...
      <div className="sticky top-0 z-40 bg-black/90 border-b border-[rgba(var(--mg-primary),0.2)] py-1.5 px-4 text-xs text-[rgba(var(--mg-primary),0.8)] flex justify-between backdrop-blur-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[rgba(var(--mg-text),0.7)]">STATUS:</span>{' '}
          <span className="text-[rgba(var(--mg-primary),0.9)] ml-1 mg-subtitle">ACTIVE</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-[rgba(var(--mg-text),0.7)]">QUANTUM LINK:</span>{' '}
          <span className="text-[rgba(var(--mg-success),1)] ml-1">ACTIVE</span>
          <span className="ml-4 font-mono text-[rgba(var(--mg-text),0.8)]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              ...
              <motion.div
                ...
                style={{
                  top: '50%',
                  background:
                    'linear-gradient(to right, transparent, rgba(0, 215, 255, 0.3), transparent)',
                }}
                animate={{
                  top: ['0%', '100%', '0%'],
                }}
            ...
            <div className="relative z-10 text-center">
              ...
              >
                <p>
                  Thank you for your interest in joining AydoCorp. Our recruitment process is
                  designed to ensure that we bring in dedicated individuals who align with our
                  values and can contribute to our mission.
                </p>
                ...
                <div className="mg-container p-4 bg-[rgba(var(--mg-background),0.4)]">
                  ...
                  <ol className="space-y-4 ml-6 list-decimal">
                    <li className="text-sm">
                      <span className="text-[rgba(var(--mg-primary),0.9)] font-bold">
                        Join our Discord server
                      </span>{' '}
                      - Our Discord server is the central hub for all AydoCorp communications and
                      activities.
                    </li>
                    <li className="text-sm">
                      <span className="text-[rgba(var(--mg-primary),0.9)] font-bold">
                        Assign yourself the Prospective Member role
                      </span>{' '}
                      - This will give you access to public channels.
                    </li>
                    <li className="text-sm">
                      <span className="text-[rgba(var(--mg-primary),0.9)] font-bold">
                        Familiarize yourself with our rules and structure
                      </span>{' '}
                      - Take some time to understand how AydoCorp operates.
                    </li>
                    <li className="text-sm">
                      <span className="text-[rgba(var(--mg-primary),0.9)] font-bold">
                        After two weeks, request an interview
                      </span>{' '}
                      - This allows you to get to know us and for us to learn more about you.
                    </li>
                    <li className="text-sm">
                      <span className="text-[rgba(var(--mg-primary),0.9)] font-bold">
                        Complete the interview process
                      </span>{' '}
                      - If successful, you&apos;ll be welcomed as a full member of AydoCorp.
                    </li>
                  </ol>
                </div>
                ...
                <div className="mt-4">
                  ...
                  <ul className="space-y-2 ml-6 list-disc text-sm">
                    <li>
                      AydoCorp is not an exclusive organization - you may maintain membership in
                      other organizations.
                    </li>
                    <li>
                      We have a zero-tolerance policy for criminal activity within official
                      operations.
                    </li>
                    <li>
                      You will need to use the same username in Discord as your in-game Star Citizen
                      handle.
                    </li>
                    <li>
                      We focus on logistics, transportation, and related activities within Star
                      Citizen.
                    </li>
                  </ul>
                </div>
