...
// Mirrors MobiGlasButton's primary/sm/fullWidth styling so footer links can be
// rendered as anchors directly (avoids nesting a <button> inside an <a>).
const mgButtonClasses = [
  'relative inline-flex items-center justify-center w-full',
  'tracking-wider transition-all duration-300',
  'mg-button border border-[rgba(var(--mg-primary),0.5)] text-[rgba(var(--mg-primary),1)]',
  'hover:bg-[rgba(var(--mg-primary),0.2)] hover:border-[rgba(var(--mg-primary),0.8)]',
  'px-3 py-1.5 text-xs',
].join(' ');

const mgButtonStyle = { fontFamily: "'Quantify', sans-serif" } as const;
            ...
            <div>
              ...
              >
                <p className="text-[rgba(var(--mg-text),0.7)]">
                  Connecting humanity across the cosmos with innovative transportation solutions.
                </p>
              </motion.div>
            </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="font-quantify tracking-wider mg-flicker">SYS_{randomId}</div>
                </div>
              </motion.div>
