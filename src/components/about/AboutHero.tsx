...
export default function AboutHero({ onInitializeDataFeed }: AboutHeroProps) {
  // Self-contained timer to prevent parent re-renders. Initialized to null so the
  // server and first client paint match; the real clock is set after mount.
  const [time, setTime] = useState<Date | null>(null);
  // Particle metadata is generated once after mount to avoid Math.random() in the
  // render path (which would diverge between SSR and hydration). Empty on the server.
          ...
          >
            ...
            >
              <p className="text-[rgba(var(--mg-text),0.8)] mb-6">
                Discover the journey of Aydo Intergalactic Corporation, from its humble beginnings
                to becoming a leader in interstellar logistics and transportation services.
              </p>
