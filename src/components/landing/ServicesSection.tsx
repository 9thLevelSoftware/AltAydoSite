...
const services = [
  {
    ...
    description:
      'Our hauling and cargo management technicians provide the expertise and manpower to handle your cargo needs efficiently and securely.',
    details: [
  ...
  },
  {
    ...
    icon: cdn('/Aydo_Corp_logo_Silver.png'),
    description:
      'Our pilots ensure you reach your destination safely and speedily, with premium transport options for individuals and groups.',
    details: [
  ...
  },
  {
    ...
    icon: cdn('/Aydo_Corp_logo_Silver.png'),
    description:
      'Our sourcing specialists scour the stars for exactly what you need, with our industrial subsidiary providing resources in bulk.',
    details: [
  ...
  },
  {
    ...
    icon: cdn('/Aydo_Corp_logo_Silver.png'),
    description:
      "Whether you're stuck adrift or need salvaged ships moved elsewhere, our specialized towing equipment and experienced crew have you covered.",
    details: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-[rgba(var(--mg-text),0.7)] max-w-3xl mx-auto">
            Aydo Intergalactic Corporation offers comprehensive logistics solutions tailored to your
            specific needs. Explore our services below and discover how we can help your operation
            thrive.
          </p>
        </motion.div>
              ...
              <motion.div
                className={`mg-container p-6 h-full cursor-pointer transition-all duration-300 ${
                  activeService === service.id
                    ? 'border-[rgba(var(--mg-primary),0.6)]'
                    : 'border-[rgba(var(--mg-primary),0.2)]'
                }`}
                whileHover={{
              ...
              >
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-[rgba(var(--mg-text),0.7)]">{service.description}</p>
