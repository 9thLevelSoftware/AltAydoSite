...
const HoloModal: React.FC<HoloModalProps> = ({
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      // End the boot sequence once the intro animation has played out.
      // (~0.5s boot reveal + ~1s hold, matching the previous onAnimationComplete delay)
            ...
            <div className="mg-panel bg-[rgba(var(--mg-panel-dark),0.8)] border border-[rgba(var(--mg-primary),0.3)] relative h-full flex flex-col overflow-hidden">
              ...
              <div className="flex items-center justify-between border-b border-[rgba(var(--mg-primary),0.3)] p-4 relative">
                ...
                <motion.h2
                  ...
                  animate={{
                    textShadow: ['0 0 5px #3f7eaa4d', '0 0 10px #3f7eaa80', '0 0 5px #3f7eaa4d'],
                  }}
                ...
                {showCloseButton && (
                  ...
                  >
                    ...
                    <motion.div className="absolute inset-0 opacity-0 group-hover:opacity-100 overflow-hidden">
                      <motion.div
